...
## MARKT
#KERNEL_CFLAGS += -include $(ANDROID_BUILD_TOP)/../../autoconf.h
KERNEL_CFLAGS += -DCONFIG_TARGET_MODEL_`echo $(TARGET_PRODUCT) | tr [:lower:] [:upper:]`=1
ifneq ($(filter if_s200n, $(TARGET_PRODUCT)),)
KERNEL_CFLAGS += -DCONFIG_TARGET_PRODUCT_IF_S200N
endif
ifneq ($(filter if_s700n, $(TARGET_PRODUCT)),)
KERNEL_CFLAGS += -DCONFIG_TARGET_PRODUCT_IF_S700N
endif
ifneq ($(filter if_mkt200, $(TARGET_PRODUCT)),)
KERNEL_CFLAGS += -DCONFIG_TARGET_PRODUCT_IF_MKT200
endif
## MARKT
...
$(TARGET_PREBUILT_INT_KERNEL): $(KERNEL_OUT) $(KERNEL_HEADERS_INSTALL)
	...
	$(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) KCFLAGS="$(KERNEL_CFLAGS)" TARGET_PRODUCT=$(TARGET_PRODUCT)
	$(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) KCFLAGS="$(KERNEL_CFLAGS)" TARGET_PRODUCT=$(TARGET_PRODUCT) modules
