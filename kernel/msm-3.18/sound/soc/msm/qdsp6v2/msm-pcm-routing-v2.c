...
#if defined(CONFIG_TARGET_PRODUCT_IF_S700N) || defined(CONFIG_TARGET_PRODUCT_IF_MKT200) // wsshim - for BT-SCO
static const struct snd_kcontrol_new quinary_mi2s_rx_port_mixer_controls[] = {
	SOC_SINGLE_EXT("INTERNAL_BT_SCO_TX", MSM_BACKEND_DAI_QUINARY_MI2S_RX,
    MSM_BACKEND_DAI_INT_BT_SCO_TX, 1, 0, msm_routing_get_port_mixer,
    msm_routing_put_port_mixer),	
};
#endif
...
static const struct snd_soc_dapm_widget msm_qdsp6_widgets[] = {
	...
	*/
    ...
    quinary_mi2s_rx_port_mixer_controls,
    ARRAY_SIZE(quinary_mi2s_rx_port_mixer_controls)),	
#endif
...
#if defined(CONFIG_TARGET_PRODUCT_IF_S200N) || defined(CONFIG_TARGET_PRODUCT_IF_S700N) || defined(CONFIG_TARGET_PRODUCT_IF_MKT200)/*by dusin.jang at 20180420*/
	{"MultiMedia9 Mixer", "QUAT_MI2S_TX", "QUAT_MI2S_TX"},
#endif
