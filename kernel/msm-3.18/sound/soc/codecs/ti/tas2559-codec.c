...
#if 1//wjhyun TODO : add tas5766 codec
			   ...
			   struct snd_soc_dai *dai)
{
	...
	if(!get_tasxxx_amp_type()) //wjhyun TODO : add tas5766 codec
		return 0;  
			     ...
			     struct snd_soc_dai *dai)
{
	...
	if(!get_tasxxx_amp_type()) //wjhyun TODO : add tas5766 codec
	{
		dev_err(pTAS2559->dev, "%s,skip tas2559_shutdown\n", __func__);
	}
	else
	{
		mutex_lock(&pTAS2559->codec_lock);
...
int tas2559_register_codec(struct tas2559_priv *pTAS2559)
{
	...
	dev_info(pTAS2559->dev, "WON : %s, enter\n", __func__);
