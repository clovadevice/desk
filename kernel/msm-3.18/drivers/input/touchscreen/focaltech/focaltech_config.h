 ...
 */
 #if defined(CONFIG_TARGET_PRODUCT_IF_MKT200)
// khs add touch type. 
#define USE_TOUCH_TYPE
#define FT5626_DESK 0
#define FT5446_FACE 1
#endif

#if defined(CONFIG_TARGET_PRODUCT_IF_S200N)
#define FTS_CHIP_TYPE   _FT5446
#elif defined(CONFIG_TARGET_PRODUCT_IF_S700N)
#define FTS_CHIP_TYPE   _FT5626
#elif defined(USE_TOUCH_TYPE)
#define FTS_CHIP_TYPE     0x0
#define FTS_CHIP_TYPE_0   _FT5626
#define FTS_CHIP_TYPE_1   _FT5446
#endif
 ...
 */
#if defined(CONFIG_TARGET_PRODUCT_IF_S200N)
#define FTS_UPGRADE_FW_APP                      "include/firmware/FT5446_5.5inch_0x09_20180214_app.i"
#elif defined(CONFIG_TARGET_PRODUCT_IF_S700N)
#define FTS_UPGRADE_FW_APP                      "include/firmware/FT5626_V05_D01_20180920_app.i"
#elif defined(USE_TOUCH_TYPE)
#define FTS_UPGRADE_FW_APP_0                    "include/firmware/FT5626_V05_D01_20180920_app.i"
#define FTS_UPGRADE_FW_APP_1                    "include/firmware/FT5446_5.5inch_0x09_20180214_app.i"
#endif
 ...
 */
#if defined(CONFIG_TARGET_PRODUCT_IF_S200N)
#define FTS_VENDOR_1_ID                        	0x79
#define FTS_VENDOR_2_ID                       	0x79
#elif defined(CONFIG_TARGET_PRODUCT_IF_S700N)
#define FTS_VENDOR_1_ID                        	0xA0
#define FTS_VENDOR_1_ID_2                      	0x58
#define FTS_VENDOR_1_ID_3                      	0x82
#define FTS_VENDOR_2_ID                       	0x2C
#elif defined(USE_TOUCH_TYPE)
#define FTS_0_VENDOR_1_ID                      	0xA0
#define FTS_0_VENDOR_1_ID_2                    	0x58
#define FTS_0_VENDOR_1_ID_3                    	0x82
#define FTS_0_VENDOR_2_ID                      	0x2C
#define FTS_1_VENDOR_1_ID                      	0x79
#define FTS_1_VENDOR_2_ID                      	0x79
#endif
 ...
 * default: enable
 */
#define FTS_GET_VENDOR_ID_FROM_FLASH            1

/* get project id from flash
 * default: disable
 */
#define FTS_GET_PROJECT_ID_FROM_FLASH           0
