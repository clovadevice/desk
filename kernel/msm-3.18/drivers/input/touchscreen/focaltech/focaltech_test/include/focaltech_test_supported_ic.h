...
{
	Code_FT8736_ENTER_FACTORY_MODE,//All IC are required to test items
	Code_FT8736_DOWNLOAD,//All IC are required to test items
	Code_FT8736_UPGRADE,//All IC are required to test items
	...
	Code_FT8736_WRITE_CONFIG,//All IC are required to test items
